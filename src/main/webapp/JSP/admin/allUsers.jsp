...
<tr>
<th style="color:green;background-color:yellow;">Username</th>
<th style="color:green;background-color:yellow;">Password</th>
</tr>
<%
...
<tr>
  ...
  <td style="color:blue;"><%=user.getPassword() %></td>
</tr>
<%} %>
</body>
</html>