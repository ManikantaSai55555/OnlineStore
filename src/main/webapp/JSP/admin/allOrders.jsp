<%@ page import="java.util.*,com.src.model.*,com.src.service.*"
...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link"
					href="./welcomeAdmin.jsp">Items</a></li>
				<li class="nav-item"><a class="nav-link" href="./allUsers.jsp">Users</a>
				</li>
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="./allOrders.jsp">Orders</a></li>
			</ul>
		</div>
	...
	<table class="table table-bordered" border="1"
		...
		<tr>
			...
			<th style="color: green; background-color: yellow;"><b>Item
					Name</b></th>
			<th style="color: green; background-color: yellow;"><b>User
					Name</b></th>
			<th style="color: green; background-color: yellow;"><b>Quantity</b></th>
			<th style="color: green; background-color: yellow;"><b>Total
					Amount</b></th>
		...
		%>
		<tr>
			<td style="color: blue;"><img src=<%=item.getUrl()%>
				alt="Item image" width="80%" height="80%" /></td>
			...
			<td><a
				href="../../ordersservlet?mode=deliver&itemname=<%=item.getItemname()%>&username=<%=user.getUsername()%>&quantity=<%=order.getOrderQuantity()%>"
				type="button" class="btn btn-primary"><%=(order.getStatus().equals("delivered")) ? "<span>&#10003;</span>" : "Deliver"%></a></td>
		</tr>
		<%
		}
		%>
